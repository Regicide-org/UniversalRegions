...
/**
 * Called when a {@link UniversalRegions} plugin tries to load {@link UniversalRegion}.
 */
public final class UniversalRegionLoadEvent extends Event implements Cancellable {
    ...
    /**
     * @param uRegion The {@link UniversalRegion} that {@link UniversalRegions} plugin tries to load.
     */
    public UniversalRegionLoadEvent(@NotNull final UniversalRegion uRegion) {
