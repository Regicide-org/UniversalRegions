...
/**
 * Called when {@link UniversalRegion} plugin tries to unload {@link UniversalChunk}.
 */
public final class UniversalChunkUnloadEvent extends Event implements Cancellable {
    ...
    /**
     * @param uChunk The {@link UniversalChunk} that {@link UniversalRegions} plugin tries to create.
     */
    public UniversalChunkUnloadEvent(@NotNull final UniversalChunk uChunk) {
